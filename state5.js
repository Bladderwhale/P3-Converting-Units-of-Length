...
demo.state5.prototype = {
    ...
    create:function(){
        ...
        this.questions.q0.setText("What is " + this.metre + " km " + this.cm +" m "+ "in metres? ");
        ...
        //
        this.measurement = GameInstance.add.text(550,365,"m");
       ...
       this.cloudtxt0 = GameInstance.add.text(700,295,"1 km = 1000 m" + "\n" + this.metre + " km = " + this.metre*100 + " m");
