...
demo.state2.prototype = {
    ...
    create: function () {
        ...
        this.draw.btnCheck.events.onInputDown.add(function () {
            ...
            if ((this.input0.value == this.correctAns && this.total <= 3) || (this.input0.value == this.metre*100+this.arr0[0] && this.total == 4) || (this.input0.value == this.metre*100+this.arr1[0] && this.total == 5)) {
                if (this.total == 4) {
                    ...
                    this.numAns.setText(this.metre*100 + this.arr0[0] + '' );
                    
                }
                if (this.total == 5) {
                    this.questions.q0.setText("What is " + this.metre + " m " + this.arr1[0] + " cm " + "in centimetres? ");
                    this.word.setText(this.metre + "  m  " + this.arr1[0] + "  cm  ")
                    this.text0.setText(this.metre + " m " + this.arr1[0] + " cm ");
                    this.text00.setText(this.metre + " m " + this.arr1[0] + " cm ");
                    this.text11.setText(this.metre + " m ");
                    this.text2.setText(this.arr0[0] + " cm ");
                    this.text22.setText(this.arr1[0] + " cm ");
                    this.text3.setText(this.metre * 100 + this.arr1[0] + " cm ");
                    this.numAns.setText(this.metre*100 + this.arr1[0] + '' );}
                ...
                if (this.input0.value == this.metre*1+this.cm && this.total<=3 || this.input0.value == this.metre*10+this.cm  && this.total<=3|| this.input0.value == this.metre*1+this.arr0[0]&& this.total==4 || this.input0.value == this.metre*10+this.arr0[0]&& this.total==4 || this.input0.value == this.metre*1+this.arr1[0]&& this.total== 5 || this.input0.value == this.metre*10+this.arr1[0]&& this.total==5   ) {
                    if (this.total !== 4 || this.total !== 5) {
                ...
                else if (this.input0.value !== this.metre*1+this.cm|| this.input0.value !== this.metre*10+this.cm) {
                    this.draw.btnTryAgain.visible = false;
                    this.txtTryAgain.visible = false;
        ...
        this.desc = GameInstance.add.text(1005, 885, "cm to m to cm");
    ...
    randomNumbers: function () {
        ...
        console.log("mapped arr", arr2)


        return { metreProperty: metre, cmProperty: cm, arr0: arr0, arr1: arr1 }
    }
